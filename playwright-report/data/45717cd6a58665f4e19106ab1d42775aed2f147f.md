...
- Name: exam.spec.ts >> Exam Architecture >> should protect /exam/[id]/live and redirect to login if not authenticated
- Location: e2e\exam.spec.ts:16:7
...
Received string:  "http://localhost:3000/exam/test-contest-id/live"
Timeout: 30000ms

Call log:
  - Expect "toHaveURL" with timeout 30000ms
    60 × unexpected value "http://localhost:3000/exam/test-contest-id/live"
